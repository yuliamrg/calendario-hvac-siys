...
| **Hecho verificado** | package.json, package-lock.json, src/core.js y el APP_VERSION embebido en dist/ declaran 0.17.0-beta.1; stable-version.txt contiene v0.15.0. | La separación main-beta/stable-puntero es coherente con el workflow, pero sólo se comprobó el repositorio local, no el despliegue vivo. |
